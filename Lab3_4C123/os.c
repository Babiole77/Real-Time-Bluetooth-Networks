...
typedef struct ptc ptcType;
tcbType tcbs[NUMTHREADS];
tcbType *RunPt;
int32_t Stacks[NUMTHREADS][STACKSIZE];
ptcType ptcs[NUMPERIODIC];
...
void SetInitialStack(int i){
  ...
  Stacks[i][STACKSIZE-1] = 0x01000000;   // thumb bit
	// second is a program counter
	// Other variables are randomly initialized
...
// ******** OS_Wait ************
// Decrement semaphore and fs if less than zero
